...
bool BVH::contains(const vec3 &center, const vec3 &dim, const vec3 &ve)
{
	if (ve.e[0] >= center.e[0] + dim.e[0] / 2 || ve.e[0] < center.e[0] - dim.e[0] / 2)
		return false;
	if (ve.e[1] >= center.e[1] + dim.e[1] / 2 || ve.e[1] < center.e[1] - dim.e[1] / 2)
		return false;
	if (ve.e[2] >= center.e[2] + dim.e[2] / 2 || ve.e[2] < center.e[2] - dim.e[2] / 2)
		return false;
